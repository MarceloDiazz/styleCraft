  ...
  <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
    <a class="flex items-center ps-2.5 mb-5" href="/h" title="bird icons">
     ...
     <ul class="space-y-2 font-medium">
        <li>
           <a href="./components/products/+product.svelte" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
