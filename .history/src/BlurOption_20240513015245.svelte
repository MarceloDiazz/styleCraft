<script lang="ts">
  ...
  import { rangeStrength, selectedBlurOption, tokenImage } from "./store";
...
<div class="flex gap-10  mt-10 ">
  ...
  <button type="button" class="text-white bg-[#009c8c] hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-green-300 dark:focus:ring-green-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 w-full max-w-32 ">Transformar</button>