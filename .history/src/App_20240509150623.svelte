<script lang="ts">
  ...
  const handleClick =(event: any) =>{
   let elementSelected= document.getElementById(event.target.id)
   elementSelected?.classList.add("border-b-gray-500")
  }
</script>
  ...
  <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
    ...
    <ul class="space-y-2 font-medium">
      <li>
        ...
        class="border-t-2 border-blue-700 flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
        >
        <svg
