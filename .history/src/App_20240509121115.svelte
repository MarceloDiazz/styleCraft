    ...
    <a class="flex items-center ps-2.5 mb-5" href="#/" title="bird icons">
     ...
     <ul class="space-y-2 font-medium">
      <li>
        ...
        <label for="react-option" class="inline-flex items-center justify-between w-full  text-gray-500  border-2 rounded-lg cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 peer-checked:border-blue-600 hover:text-gray-600 dark:peer-checked:text-gray-300 peer-checked:text-gray-600 hover:bg-gray-50 dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700">                           
...
>
  ...
  <footer class="flex justify-center items-center gap-x-2 font-semibold pt-10">
    Hecho con <a href="h/ttps//:cloudinary" target="_blank" rel="noreferrer"
      ><CloudinaryLogo /></a
    >
  </footer>
</div>
