...
<div >
  <div
    class="max-w-sm m-auto grid gap-5 grid-cols-1 place-content-center w-full h-screen p-4 max-sm:p-10"
  >
    <div>
      <div class="flex justify-center items-center ps-2.5 mb-5" title="bird icons ">
        <img src={logo} class=" me-3 sm:h-15" alt="Flowbite Logo" fetchpriority="high"/>
        <span
      ...
      {#if $imageStatus === ImageStatus.READY}
        <div>
          <img src={demo} alt="demo" fetchpriority="high"/>
      </div>
      {/if}
    </div>
    <main>
