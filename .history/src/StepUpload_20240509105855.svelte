...
>
  ...
  <div class="absolute flex items-center justify-center h-full w-full  rounded-lg">
    <div class="px-3 py-10 text-xl font-medium leading-none text-center text-blue-800 bg-blue-200 rounded-full animate-pulse dark:bg-blue-900 dark:text-blue-200">loading...</div>
</div>
  <!-- {/if} -->
</form>
