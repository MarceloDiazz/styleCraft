...
>
  ...
  <strong
    class="text-lg text-black uppercase text-3xl font-bold absolute h-full bg-slate-500 opacity-70 w-full rounded-lg flex items-center justify-center flex-col"
  >
    Uploading files ...
  </strong>
  <!-- {/if} -->
