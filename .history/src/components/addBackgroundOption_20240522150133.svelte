<script lang="ts">
  ...
  console.log($selectTypeImage === "noTransparent");
  console.log($selectTypeImage === "transparent");
  ...
  <div>
    ...
    <div class="flex flex-col gap-5 mt-5">
      <button
        ...
        class={`border rounded-xl p-3 ${$selectTypeImage === "noTransparent" ? "border-blue-400": "border-gray-200"}`}>Con fondo</button
      >
      <button
        on:click={() => {
          selectTypeImage.set("transparent");
        }}
        class="border rounded-xl p-3 ${$selectTypeImage === "transparent" ? "border-blue-400": "border-gray-200"}">Sin fondo</button
      >
    </div>
  </div>
