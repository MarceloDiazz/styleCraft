  ...
  <div class=" relative h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
    ...
    <ul class="mt-16 space-y-6 font-medium">
      ...
      >
        ...
        >
          <img alt="removeBackground" class="w-5 h-5" src={removeBackground} />
      ...
      >
        <button
          ...
          class={` flex items-center p-2 text-gray-900  dark:text-white  dark:hover:bg-gray-700 group`}
        >
          <img alt="restore" class="w-5 h-5" src={restore} />
      ...
      >
        <button
          ...
          class={` flex items-center p-2 text-gray-900  dark:text-white  dark:hover:bg-gray-700 group`}
        >
          <img alt="blur" class="w-5 h-5" src={blur} />
      ...
      >
        <button
          ...
          class={` flex items-center p-2 text-gray-900  dark:text-white  dark:hover:bg-gray-700 group`}
        >
          <img alt="rounded" class="w-5 h-5" src={rounded} />
      ...
      >
        <button
          ...
          class={` flex items-center p-2 text-gray-900  dark:text-white  dark:hover:bg-gray-700 group`}
        >
          <img alt="rotate" class="w-5 h-5" src={rotate} />
      ...
      >
        <button
          ...
          class={` flex items-center p-2 text-gray-900 dark:text-white  dark:hover:bg-gray-700 group`}
        >
          <img alt="addBackground" class="w-5 h-5" src={addBackground} />
