...
<!-- on: como el onclick  -->
<two-up>
  <img class="max-h-60" src={$originalImage} alt="Imagen original subida por el usuario" />
  {#if processingImage}
  ...
  {:else}
    <img class="max-h-60" src={$modifiedImage} alt="Imagen sin fondo subida por el usuario" />
  {/if}
</two-up>
