  ...
  <div class="flex items-center mt-10">
    <div class="flex-1  max-w-15">
      <div class="flex  flex-col gap-2">
        ...
        <!-- Value Range -->
        <form class="max-w-sm ">
          <label for="number-input" class=" mb-2 text-sm font-medium text-gray-900 dark:text-white">Select a number:</label>
          <input type="number" id="number-input" aria-describedby="helper-text-explanation" class="w-20 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block  p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder={`${Number($rangeValue)}`} required />
      </form>
      </div>
    </div>
