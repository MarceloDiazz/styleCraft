...
<!-- on: como el onclick  -->
<two-up class="max-h-96">
  <img class="max-h-96" src={$originalImage} alt="Imagen original subida por el usuario" />
  {#if processingImage}
  ...
  {:else}
    <img class="max-h-96" src={$modifiedImage} alt="Imagen sin fondo subida por el usuario" />
  {/if}
</two-up>
