...
>
  ...
  <div class="absolute flex justify-center h-full w-full  rounded-lg">
    <div class=" h-full m-auto w-full text-xl font-medium leading-none text-center text-blue-800 bg-blue-200 animate-pulse dark:bg-blue-900 dark:text-blue-200">loading...</div>
</div>
  <!-- {/if} -->
</form>
