...
export const selectModeBackground = writable("predominant");
export const selectTypeImageBackground = writable("transparent");
export const selectColorBackground = writable("#FFFFFF");

// edit section

export const readyImage= writable(false)
